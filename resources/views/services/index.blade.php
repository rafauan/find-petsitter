        ...
        <div class="p-4 my-12 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="flex flex-col">
                ...
                <div class="flow-root mb-4">
                    <h2 class="font-semibold float-left align-middle">{{ __('List of services') }}</h2>
                    <a href="{{ route('services.create')}}" class="float-right inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:ring-offset-2 transition ease-in-out duration-150">
                        {{ __('Create') }}
                    </a>
                </div>
                ...
                <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full">
                        ...
                        @foreach($services as $service)
                            <tr class="border-b hover:bg-gray-200 cursor-pointer transition ease-in-out duration-150" onclick="window.location='/services/{{ $service->id }}'">
