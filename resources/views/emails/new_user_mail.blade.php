...
{{-- <h1>Witaj, </h1>
<p>W systemie zarejestrował się nowy użytkownik,</p>
<p>Imię: {{ $user_name }}</p>
<p>E-mail: {{ $user_email }}</p>

@if($user_role == 'Customer') 
    <p>Typ konta: klient</p>
@else
    <p>Typ konta: {{ $user_role }}</p>
@endif

<p class="text-gray-400">Zweryfikuj profil, aby zmienić jego status:</p>
<a href='{{ url("/users/$user_id") }}'>Link:</a> --}}
